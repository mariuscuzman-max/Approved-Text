...
export const words: WordDefinition[] = [
  ...
  createWord({
    ...
    tapValue: 0.3,
    passiveValue: 0.3,
    effectDescription: 'Connects another noun and grants +10% total tap and passive gain while active.',
    specialEffectType: 'connector_production_multiplier',
  ...
  createWord({
    ...
    tapValue: 0.12,
    passiveValue: 0,
    effectDescription: 'Adds 0.5% of current Meaning to the target noun clause tap gain.',
  ...
  createWord({
    ...
    tapValue: 0.005,
    passiveValue: 0.05,
    effectDescription: 'Every 5 active minutes triggers 30 seconds of +50% total gains.',
