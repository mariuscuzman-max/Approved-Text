# Approved Text - Word Pool Map

This is a planning reference for the first shared, Farm, Flow, and Dream word pools. The listed powers are metadata only unless marked implemented.

## Design Notes

* Words are not just skins.
* Each word should eventually have base production plus a special rule.
* Upgrades provide general scaling.
* Paths provide playstyle identity.
* Events provide temporary bursts.
* Sentence synergies will later combine word effects.

## Shared Starter Word

| Unlock Meaning | Word | Type | Path | Tap | Passive | Possible power | Status |
| ---: | --- | --- | --- | ---: | ---: | --- | --- |
...
Role: active/manual progression, tapping power, stamping events, and strong active scaling.

| Unlock Meaning | Word | Type | Path | Tap | Passive | Possible power | Status |
| ---: | --- | --- | --- | ---: | ---: | --- | --- |
| 2 | Farm | noun | Farm / Ground Path | 0.02 | 0 | +25% path tapping bonus | Implemented |
...
Role: passive/idle progression, Meaning/sec, waiting and returning, and efficiency.

| Unlock Meaning | Word | Type | Path | Tap | Passive | Possible power | Status |
| ---: | --- | --- | --- | ---: | ---: | --- | --- |
| 2 | Water | noun | Water / Flow Path | 0.005 | 0.003 | +25% path idle bonus | Implemented |
...
Role: later random events, burst gains, strange synergies, and unstable high-value moments. Dream is not part of the first Farm/Flow choice.
...
| 1,000 | Dice | noun | Dream / Chance Path | 0.01 | 0.01 | Small chance for x5 tap | Planned |
| 5,000 | Omen | noun | Dream / Chance Path | 0.01 | 0.01 | Reveals or improves upcoming special effects/events | Planned |
| 25,000 | Lucid | adjective | Dream / Chance Path | 0.01 | 0.01 | Stabilizes Dream randomness | Planned |
| 100,000 | Mirror | noun | Dream / Chance Path | 0.01 | 0.01 | Copies part of another word's base statistics | Planned |
| 250,000 | Nightmare | noun | Dream / Chance Path | 0.01 | 0.01 | High reward paired with a drawback | Planned |
| 10,000 | Vision | noun | Dream / Chance Path | 0.01 | 0.01 | Event rectangles stay visible longer | Planned |
| 50,000 | Sleep | noun | Dream / Chance Path | 0.01 | 0.01 | Chance for idle burst later | Planned |
| 100,000 | Whim | noun | Dream / Chance Path | 0.01 | 0.01 | Random temporary multiplier later | Planned |
| 500,000 | Miracle | noun | Dream / Chance Path | 0.01 | 0.01 | Rare huge reward later | Planned |
| 1,000,000 | Accident | noun | Dream / Chance Path | 0.01 | 0.01 | Expired/failed events may still give partial reward later | Planned |
